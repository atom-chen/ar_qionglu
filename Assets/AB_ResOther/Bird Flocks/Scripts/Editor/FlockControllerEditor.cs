...
public class FlockControllerEditor: Editor {
    ...
    public override void OnInspectorGUI() {
        FlockController  target_cs = (FlockController)target;
        ...
        GUIContent  gcContent=new GUIContent("GameObjecyPrefabs");
   EditorGUILayout.PropertyField(tps, gcContent,true);
        serializedObject.ApplyModifiedProperties();
       // target_cs._childPrefab = EditorGUILayout.("Bird Prefab", target_cs._childPrefab, typeof(FlockChild),false) as FlockChild[];
